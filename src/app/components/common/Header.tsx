function Header() {
   return (
      <header className="flex flex-col items-center justify-center p-3 fixed top-0 left-0 h-32 md:h-28 w-full bg-cyan-900 z-40">
         ...
         <p className="text-xs mt-1 text-center">(Disclaimer: The information used in this site is extracted from <strong>University Admission Handbook - 23/24</strong>)</p>
      </header>
   )
}
